...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        slope = -beta1 / beta2  # Slope of the decision boundary
        intercept = -beta0 / beta2  # Intercept of the decision boundary
        ...
        # if beta2 != 0:
        #     x2_vals = - (beta0 / beta2) - (beta1 / beta2) * x1_vals
        #     plt.plot(x1_vals, x2_vals, color='red', linestyle='--', linewidth=2, label="Decision Boundary")
        ...
        plt.text(x_vals[0], y_vals[0] + 0.5, equation_text, fontsize=24, color="black", ha='left',
    ...
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, marker='o', color='r')
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, marker='o', color='g')
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, marker='o', color='m')
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, marker='o', color='m')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, marker='o', color='y')
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, marker='o', color='c')
